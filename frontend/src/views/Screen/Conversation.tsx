      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <button
            ...
            className={cn(
              'absolute h-8 min-w-8 z-10 -translate-y-full opacity-70 hover:opacity-100 transition-opacity',
              {
        ...
        <FloatingPortal>
          <FloatingFocusManager context={context} modal={false}>
            <Card
              ...
              className="w-96 max-h-96 z-10 overflow-hidden overflow-y-auto"
              {...getFloatingProps()}
            >
